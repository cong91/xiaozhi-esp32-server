export default {
  ...
  'common.networkRequestError': 'Network request error [{status}]',
  'common.cannotConnectServer': 'Unable to connect to the server',
  'common.connectingServer': 'Connecting to the server ({index})',
